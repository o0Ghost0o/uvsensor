...
class BluetoothSDKListenerHelper {
    companion object {
        ...
        class BluetoothSDKBroadcastReceiver : BroadcastReceiver() {
            private var mGlobalListener: BluetoothUtils.IBluetoothSDKListener? = null

            public fun setBluetoothSDKListener(listener: BluetoothUtils.IBluetoothSDKListener) {
                mGlobalListener = listener
            }

            public fun removeBluetoothSDKListener(listener: BluetoothUtils.IBluetoothSDKListener): Boolean {
        ...
        public fun registerBluetoothSDKListener(
            context: Context?,
            listener: BluetoothUtils.IBluetoothSDKListener
        ) {
